...
function phelp {
    ...
    Write-Host "  h / phelp     -> Open this list of commands"
    Write-Host "  edit-profile  -> Open this profile in editor"
    Write-Host "  rl / reload   -> Restart Windows Terminal"
    Write-Host ""
...
function ... { Set-Location ..\.. } Set-Alias -Name cd... -Value ...
function .... { Set-Location ..\..\.. } Set-Alias -Name cd.... -Value ....
...
Set-Alias -Name dl -Value download
